# stm32f446 maximum-clock measurement image

Release v1.1.0, experiment `energy-profiling-v4-max-clock`, schema 2. Nominal CPU clock: **180 MHz**. Benchmark serial diagnostics are disabled; RUN is the single PPK2 D0 output.
