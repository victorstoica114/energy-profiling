...
**Common160 functional validation passed on Pico and ESP32: all twelve workloads with exact call counts and final DONE at the configured 160 MHz.** Their matching silent measurement images were installed afterward; common160 is the latest recorded installation on both boards. The [Pico diagnostic](hardware/common160/2026-09-11/rp2040_diagnostic_01.json) and [programming record](hardware/common160/2026-09-11/rp2040_measurement_programming_01.json), and the [ESP32 diagnostic](hardware/common160/2026-09-11/esp32_diagnostic_01.json) and [programming record](hardware/common160/2026-09-11/esp32_measurement_programming_01.json), preserve the separate evidence. Common160 hardware validation remains pending for STM32F446, and all three common160 PPK2 capture sets remain pending.
